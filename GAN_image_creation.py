...
class G(nn.Module): 
    ...
    def __init__(self): 
        ...
        # create a meta module of a neural network that will contain a sequence of modules (convolutions, full connections, etc.)
...
# We create the optimizer object of the discriminator and generator
...
for epoch in range(25): 
    ...
    for i, data in enumerate(dataloader, 0): 
        ...
        errD.backward() # We backpropagate the loss error 
        optimizerD.step() 
        ...
        if i % 100 == 0: 
            ...
            fake = netG(noise)  # fake generated images.
